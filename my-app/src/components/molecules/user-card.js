...
export default function UserCard({ userItem, isNew, change, reload }) {
    ...
    const validateData = () => {
        ...
        else if (!userItemData.dailyCalorieLimit || userItemData.dailyCalorieLimit > 2100|| userItemData.dailyCalorieLimit < 100) toast.error("Enter valid calorie limit");
        else if (!userItemData.monthlyBudget || userItemData.monthlyBudget > 5000 || userItemData.monthlyBudget < 100) toast.error(("Enter valid monthly budget"));
